...
module.exports = [
  ...
  /**
  * eslint-plugin-array-func doesn't (yet) provide a "flat" ESLint
  * configuration. Until an updated version is released, use `FlatCompat` to
  * provide a "flat" compatible configuration object.
  *
  * @see {@link https://www.npmjs.com/package/eslint-plugin-array-func}
   */
  ...compat.config((() => {
    const { configs: { all, recommended } } = require('eslint-plugin-array-func');
